...
class PreferencesBloc extends BlocBase {
  ...
  static const String propertyOnKey = "property_on";
  ...
  PreferencesBloc() {
    ...
    _onController.listen(_handleChangeOn);
  ...
  void _loadOn() {
    inChangeOn.add(
      _preferences.getBool(propertyOnKey) ?? defaultOn,
    );
  }
  ...
  final _onController = BehaviorSubject<bool>();
  Sink<bool> get inChangeOn {
    return _onController.sink;
  }

  Stream<bool> get outChangeOn {
    return _onController.stream;
  }
  // Dispose
  ...
  void _handleChangeOn(bool value) {
    _preferences.setBool(propertyOnKey, value);
  }
