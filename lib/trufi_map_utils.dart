...
tileHostingTileLayerOptions(){
  ...
  return TileLayerOptions(
    urlTemplate:
  "https://api.mapbox.com/styles/v1/mapbox/navigation-preview-day-v4/tiles/256/{z}/{x}/{y}@2x?access_token={accessToken}",
    additionalOptions: {
...
class Jeepney {
  ...
  static const _kFontFam = 'Jeepney';

  static const IconData jeepney = const IconData(0xe800, fontFamily: _kFontFam);
}