...
import 'package:jeepney_app/custom_icons.dart';
...
class TrufiDrawerState extends State<TrufiDrawer> {
  ...
  Widget _buildListItem(IconData iconData, String title, String route) {
    ...
    return Container(
      color: isSelected ? Color(0xFFBDBDBD) : null,
      child: ListTile(
        leading: Icon(iconData, color: isSelected ? Color(0xFF1E232F) : Color(0xFF829191)),
        title: Text(
          title,
